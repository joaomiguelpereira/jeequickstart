...
public class BusinessComponentBeanTest extends
	...
	@Test
	public void testRetrieveBusinessEntity() throws Exception{
		System.err.println("Running UNIT---------------------------");
		BusinessComponentBean sut = createBusinessComponentInstanceUnderTest();
		//Need to populate it
